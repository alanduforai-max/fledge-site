  ...
  <section class="section-tight">
    ...
    <div class="about-grid" style="margin-top:var(--space-10)">
      <div style="display:flex;flex-direction:column;gap:var(--space-6)">
        ...
        <p style="font-size:var(--size-body-sm);color:var(--text-secondary)">One line connects Claude Code; any MCP client can point at the same endpoint.</p>
        <pre class="cmd">claude mcp add --transport http fledge-grounds \\
  https://fledge-grounds-mcp.fledge-grounds-mcp.workers.dev/mcp</pre>
        <p style="font-size:var(--size-body-sm);color:var(--text-secondary)">Then ask in your own words: <em>“Pull the Verify report on the TradingAgents AAPL call — only the claims that failed.”</em> <em>“grounds_for NVDA — separate the facts that support a long from the facts that cut against it.”</em> <em>“Search 8-K filings since June for ‘cybersecurity incident’.”</em></p>
        <hr class="rule">
        <p style="font-size:var(--size-body-sm);color:var(--text-muted)">Beta. Open and unauthenticated while we run it in; fair use, no SLA. The endpoint may move when API keys land — this page always carries the current one.</p>
      </div>
      <div class="about-card">
